...
namespace ConsoleApp1
{
   ...
   public class ImproperFraction : ICloneable, IComparable, IFraction
    ...
    /// <summary>
    /// <para>
    /// This class of fraction should hold better value compare to the Improper because the integer part allows 
    /// for better flexibility</para>
    ...
    public class ProperFraction: IFraction,ICloneable
    {
        ...
        public override string ToString()
        {
            if (decimalpart.getFloatValue() == 0) return ""+ this.integerpart;
